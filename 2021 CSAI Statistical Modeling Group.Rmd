...
As a CSAI Statistical Modeling group, our aim is to read, discuss, and work through various statistical modeling approaches that are relevant to a number of research initiatives in Cognitive Science. The aims is to focus both on the conceptual and practical aspects of various statistical modeling approaches.  

## Regression Recap and Ridge/Lasso Regression

Chapter 3. Hastie, T., Tibshirani, R., & Friedman, J. (2009). Elements of Statistical Learning: Data mining, inference, and prediction. 2nd Edition.
