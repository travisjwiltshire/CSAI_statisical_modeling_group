...
As a CSAI Statistical Modeling group, our aim is to read, discuss, and work through various statistical modeling approaches that are relevant to a number of research initiatives in Cognitive Science. The aims is to focus both on the conceptual and practical aspects.  
